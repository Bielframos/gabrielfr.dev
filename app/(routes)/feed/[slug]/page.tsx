...
import { Layout } from "@/lib/components/modules"
        ...
        <div className="w-full">
          <div className="pt-6 grid gap-2 auto-rows-min">
            ...
            <p className="text-black-9 dark:text-white-9">
              O post que você está tentando acessar não foi econtrado, retorne para o feed e
              tente visualizar ele mais uma vez.
            </p>
          </div>
        </div>
      </div>
